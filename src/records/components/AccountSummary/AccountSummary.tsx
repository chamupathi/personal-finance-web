...
export function AccountSummary(props: IAccountSummaryProps) {
  return (
    <div className={`AccountSummary ${props.secondary ? 'secondary' : ''} ${props.open ? 'open' : ''}`}>
      <div className="data" onClick={props.onOpenToggle ? props.onOpenToggle : () => null}>
        <div className="wide-row top">
          <div className="amount">{props.sum}£</div>
